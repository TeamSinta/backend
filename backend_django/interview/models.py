...
class InterviewRound(models.Model):
    ...
    candidate = models.ForeignKey(
        CustomUser, related_name=CustomUser.RoleChoices.CANDIDATE, on_delete=models.CASCADE
    )
    interviewer = models.ForeignKey(
        CustomUser, related_name=CustomUser.RoleChoices.INTERVIEWER, on_delete=models.CASCADE
    )
...
class InterviewRoundQuestion(models.Model):
    interview_round = models.ForeignKey(InterviewRound, on_delete=models.CASCADE, related_name='interview_round_questions')
